...
export async function GET(request: Request) {
  try {
    console.log('DEBUG: Starting GET handler for /api/linkedin/profile/detailed');
    ...
    console.log('DEBUG: LinkedIn user info received:', userInfo);
    
    // Return the profile data
    return NextResponse.json({
      headline: userInfo.name || null, // Using name as a basic headline since /userinfo doesn't provide a headline
      summary: null, // /userinfo doesn't provide a summary
      name: userInfo.name,
